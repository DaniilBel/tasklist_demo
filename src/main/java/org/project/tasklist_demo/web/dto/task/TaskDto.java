package org.project.tasklist_demo.web.dto.task;
...
public class TaskDto {
    ...
    @Length(max = 255,
            message = "Title length must be smalelr than 255 sym",
            groups = {OnCreate.class, OnUpdate.class})
    private String title;

    @Length(max = 255,
            message = "Description length must be smalelr than 255 sym",
            groups = {OnCreate.class, OnUpdate.class})
